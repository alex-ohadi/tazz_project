...
```
docker build . -t my-eks-container-tazz
docker run -it -p 8080:80 -d --name docker-vuejs-nginx my-eks-container-tazz
...
-p 8080:80 – Port Forwarding Between Host and the Container. Right to the colon is a container and Left to the colon is Host. 8081 is the Host and 8080 is the container Port.
...
my-eks-container-tazz – The name of the image from which we are going to create a Container.
...
docker tag my-eks-container-tazz:latest 784638312003.dkr.ecr.us-east-2.amazonaws.com/my-eks-container-tazz:latest
docker push 784638312003.dkr.ecr.us-east-2.amazonaws.com/my-eks-container-tazz:latest
...
784638312003.dkr.ecr.us-east-2.amazonaws.com/my-eks-container-tazz
